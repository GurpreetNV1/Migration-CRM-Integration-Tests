"""Wires app.state for the copied Support Service integration tests in this folder.

Adapted from server/services/09_support_service/tests/conftest.py, which always forces an
