"""Wires app.state for the copied Graphics Service integration tests in this folder.

Adapted from server/services/07_graphics_service/tests/conftest.py, which always forces an
