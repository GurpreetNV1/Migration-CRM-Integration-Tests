"""Wires app.state for the copied Admin Module integration tests in this folder.

Adapted from server/services/14_admin_module/tests/conftest.py, which always forces an
