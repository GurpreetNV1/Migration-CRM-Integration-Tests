"""Wires app.state for the copied Task Service integration tests in this folder.

Adapted from server/services/03_task_service/tests/conftest.py, which always forces an
...
# This service's own test_tasks_flow.py seeds prerequisite rows directly into Contact
# (user-service-owned) and Application (application-service-owned) via app.state.gateway -- fine
